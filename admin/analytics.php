...
<?php
 ...
 $db=mysqli_select_db($connection,'foodmanagement');
...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"Nagpur\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $madurai=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"Chandrapur\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $chennai=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"Wardha\"";
...
var xplace=["Chandrapur","Wardha","Nagpur"];
