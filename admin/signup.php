        ...
        <!-- <p class="logo" style="">Food <b style="color:#06C167; ">Donate</b></p> -->
            ...
            <div class="input-field">
                        ...
                        <select id="district" name="district" style="padding:10px; padding-left: 20px;">
                          ...
                          <option value="Chandrapur">Yavatmal</option>
                          <option value="Chandrapur">Amravti</option>
                          <option value="Chandrapur">Bhandara</option>
                          <option value="Chandrapur">Akola</option>
                          <option value="Chandrapur">Bhuldhana</option>
                          <option value="Chandrapur">Gondia</option>
                        </select>
