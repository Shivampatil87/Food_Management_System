...
$sql12 = "SELECT
    fd.Fid AS Fid,
    fd.location AS cure,
    fd.name AS donor_name,
    fd.phoneno AS donor_phone,
    fd.date AS donation_date,
    fd.delivery_by,
...
";
// Execute the query
$result3=mysqli_query($connection, $sql12);
// Check for errors
if (!$result3) {
...
<a href="deliverymyord.php" style="margin-bottom:10px;">My orders</a>
        ...
        <tr>
            ...
            <tr>
                <th >Shivam</th>
                <th >9359596449</th>
                <th >02/06/2025 07:40:16</th>
                <th >Mhalgi nagar</th>
                <th >Mahal</th>
                <th ><a href="../index.php">Take order</a></th>
            </tr>
            </thead>
            </table>
