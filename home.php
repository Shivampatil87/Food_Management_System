...
<body>
    <header>
        <div class="logo"><b style="color: #06C167;"></b></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <!-- <li ><a href="SavR.html"  >Donate</a></li> -->
            </ul>
        </nav>
    </header>
    <script>
    ...
    <footer class="footer">
        ...
        <div class="footer-center col-md-4 col-sm-6">
          ...
          <div>
            ...
            <p><a href="#"> Shivammahalle41@gmail.com</a></p>
          </div>
        ...
        <div class="footer-right col-md-4 col-sm-6">
          <h2> Shivam Mahalle<span> </span></h2>
          <!-- <h2>SavR</h2> -->
          <p class="menu">
          ...
          <p class="name">Shivam @Reserved Copy-rights</p>
        </div>
      </footer>
